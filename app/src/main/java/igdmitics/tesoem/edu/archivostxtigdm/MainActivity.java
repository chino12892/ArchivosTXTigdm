package igdmitics.tesoem.edu.archivostxtigdm;
...
public class MainActivity extends AppCompatActivity {
    ...
    private final String nomarch = "datosIGDM.txt";
    ...
    public void MGrabar(View v){
        ...
        try {
            ...
            if (controlador.grabar(TextoCompleto,
                    this,nomarch)){
    ...
    private void CargarInfo(){
        ...
        if (objmanarch.verifica(this,nomarch)){
            ...
            if (objmanarch.leer(this,nomarch)){
                ...
                //lblmostrar.setText(objmanarch.getContenido());
            }
        } else{
